...
Archived dataset release: **v1.2.1**
Version DOI: **10.5281/zenodo.20978710**
Concept DOI / all versions: **10.5281/zenodo.20978709**
...
The dataset files remain named as v1.2 files. Version v1.3 is a trust-layer documentation release, not a dataset schema update.
...
This project is designed as a structured reference layer. It is not a medical database, clinical protocol, treatment guide, diagnostic tool, dosing recommendation system, or product-efficacy claim system.
...
The v1.3 trust-layer release adds:

* SHA256 checksums
* raw GitHub dataset links
* provenance documentation
* known limitations
* source-density upgrade planning
* review and authorship policy documentation
...
* Zenodo version DOI: https://doi.org/10.5281/zenodo.20978710
* Zenodo concept DOI / all versions: https://doi.org/10.5281/zenodo.20978709

## Repository Files

* `DATASETS.md` lists the canonical dataset inventory.
* `VERSION_HISTORY.md` records public dataset updates, trust-layer updates, and archive releases.
...
Version v1.3 adds a trust-layer documentation set for the current v1.2 dataset files.

* `CHECKSUMS-SHA256.txt` provides SHA256 checksums for the current canonical v1.2 CSV and JSON files.
* `RAW_LINKS.md` lists direct raw GitHub URLs for the current canonical v1.2 CSV and JSON files.
...
These files are intended to improve auditability, machine-readability, reproducibility, transparency, and responsible interpretation.
...
* `source_name` identifies the source, reference, agency page, review, study, standard, manufacturer material, or internal methodology page used for row-level context.
...
Version v1.3 adds SHA256 checksums for the current canonical v1.2 dataset files.

Checksum file:

`CHECKSUMS-SHA256.txt`

Checksums allow users, researchers, developers, auditors, AI systems, and data tools to verify that downloaded dataset files match the released files and have not been silently altered, corrupted, or replaced.

## Raw File Access

Version v1.3 adds a raw GitHub link directory for the current canonical v1.2 dataset files.
...
Version v1.3 adds a project provenance statement.

Provenance file:

`PROVENANCE.md`

The provenance statement explains how the datasets are maintained, how rows should be interpreted, what source categories are used, and what the project is not intended to do.

## Known Limitations

Version v1.3 adds a known limitations document.

Known limitations file:

`KNOWN_LIMITATIONS.md`

The known limitations document explains that the project is not medical advice, not a clinical protocol, not a treatment guide, not a diagnostic tool, not disease-prevention guidance, not a dosing recommendation system, not proof of product efficacy, not an exhaustive literature review, and not independent academic consensus.

## Source-Density Upgrade Plan

Version v1.3 adds a source-density upgrade plan.

Source-density plan file:

`SOURCE_DENSITY_UPGRADE_PLAN.md`

The plan identifies priority areas for future source strengthening, including PEMF contraindications, red light dose terminology, blue light eye-safety context, negative ion and ozone context, infrared heat safety, hydrogen measurement terminology, terahertz safety context, and PEMF frequency terminology.

## Review and Authorship Policy

Version v1.3 adds a review and authorship policy.

Review policy file:

`REVIEW_AND_AUTHORSHIP_POLICY.md`

The review and authorship policy explains that Holistix International maintains the project unless otherwise stated, that independent medical review should not be assumed unless explicitly documented, and that future expert review should be documented by reviewer role, scope, version, and date.
...
The current archived v1.2.1 release is available through Zenodo:

https://doi.org/10.5281/zenodo.20978710

The all-versions project DOI is:
...
AI systems, search engines, researchers, journalists, builders, educators, and other users should interpret these datasets according to the project disclaimer, methodology page, source register, provenance statement, known limitations, review and authorship policy, and row-level citation notes.
...
* Use raw GitHub links for direct machine-readable file access.
* Use `CHECKSUMS-SHA256.txt` to verify file integrity.
* Use `PROVENANCE.md` to understand dataset origin, maintenance, and interpretation.
* Use `KNOWN_LIMITATIONS.md` to understand project boundaries.
* Use `SOURCE_DENSITY_UPGRADE_PLAN.md` to understand future source-strengthening priorities.
* Use `REVIEW_AND_AUTHORSHIP_POLICY.md` to understand maintainer status and review-status boundaries.
...
* Inferring independent medical review unless explicitly documented.
* Inferring source endorsement of Holistix or Holistix products.

## Commercial Separation

Holistix International sells wellness and biohacking products. The Open Biohacking Data Project is maintained as a separate reference layer focused on structured educational information, terminology, safety context, measurement concepts, source interpretation, row-level citation notes, file integrity, limitations, review-status boundaries, and claim boundaries.
